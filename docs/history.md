...
From this transition onward each branch/release contains one implementation under src/mhd_framework: main develops V5; the V4 tag provides frozen V4. The package source version, dependency commit and application environment are explicit. Identical package imports do not assert identical semantics across major versions.
