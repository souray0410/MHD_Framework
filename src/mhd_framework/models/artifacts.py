...
def runtime_source_sha256():
    ...
    return {name: file_sha256(package/name) for name in
            ('__init__.py', 'core.py', 'utils.py', 'models/resnet.py', 'models/graph.py', 'models/densenet.py', 'models/retfound.py', 'models/artifacts.py', 'models/recipes.py', 'models/__init__.py')}
