...
def runtime_source_sha256():
    ...
    return {name: file_sha256(package/name) for name in
            ('__init__.py', 'core.py', 'utils.py', 'models/resnet.py', 'models/graph.py', 'models/densenet.py', 'models/retfound.py', 'models/vision_transformer.py', 'models/modern_cnn.py', 'models/dinov2.py', 'models/artifacts.py', 'models/recipes.py', 'models/training.py', 'models/__init__.py')}
