...
DeiT III blocks retain layer scaling and the no-embed-class position convention: patch positions precede class-token insertion.
...
[Original implementation](https://github.com/facebookresearch/deit)
