...
MONAI 1.5.1 native 3D dense connectivity; explicit dense-layer/transition nodes and a complete classification head.
...
[Original implementation](https://docs.monai.io/en/1.5.1/networks.html#densenet)
