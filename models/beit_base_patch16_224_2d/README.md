...
Per-block relative position bias, native pooling and layer scales are preserved. Shared relative bias variants are rejected rather than silently approximated.
...
[Original implementation](https://github.com/microsoft/unilm/tree/master/beit)
