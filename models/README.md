...
The catalog separates architecture definitions from trained artifacts. Current entries are **planned**; an empty weights list means no models artifact has been accepted. Existing synthetic tests or research-application checkpoints do not automatically certify all listed architectures.
