# swin_unetr_encoder_3d

MONAI 1.5.1 encoder only: feature width 48, patch 2^3, window 7^3, depths 2/2/2/2, heads 3/6/12/24, original patch merging. Five-level encoder output convention, four exposed stage cuts and normalized final feature mean. A new linear classifier replaces the segmentation system; no segmentation masks or segmentation claim.
...
[Original implementation](https://github.com/Project-MONAI/research-contributions/tree/main/SwinUNETR)
