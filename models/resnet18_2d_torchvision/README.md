...
| Field | Value |
|---|---|
| Architecture ID | `resnet18_2d_torchvision` |
...
Block: `BasicBlock`; blocks per stage: `[2, 2, 2, 2]`; stage output channels: `[64, 128, 256, 512]`. Default graph granularity is `block`; explicit `stage` granularity is also supported.
