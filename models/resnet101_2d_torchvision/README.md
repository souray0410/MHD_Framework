...
| Field | Value |
|---|---|
| Architecture ID | `resnet101_2d_torchvision` |
...
Block: `Bottleneck`; blocks per stage: `[3, 4, 23, 3]`; stage output channels: `[256, 512, 1024, 2048]`. Default graph granularity is `block`; explicit `stage` granularity is also supported.
