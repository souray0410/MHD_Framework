...
| Field | Value |
|---|---|
| Architecture ID | `densenet161_2d` |
...
Dense layers per block: `[6, 12, 36, 24]`. Dense connections are preserved inside each dense block; this implementation exposes dense blocks and transitions, not each internal dense layer.
