...
This branch maintains V5. V4 tensor semantics are frozen; V5 is in development. Version changes are installed explicitly through separate releases, not selected by a compatibility switch. Preserve the public MHD_Node, MHD_Edge, MHD_Topo and MHD_Graph names.
